...
void objectFuture() {
  group('DDI Object Future Basic Tests', () {
    test('Register and retrieve object bean', () async {
      DDI.instance.registerObject(Future.value('Willian Marchesan'), qualifier: 'futureAuthor');
    ...
    test('Try to retrieve object bean after removed', () {
      ...
      expect(() => DDI.instance.get(qualifier: 'futureAuthor'), throwsA(isA<BeanNotFound>()));
    });
    ...
    test('Register, retrieve and refresh object bean', () async {
      DDI.instance.registerObject(Future.value('Willian Marchesan'), qualifier: 'name');
