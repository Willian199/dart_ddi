  ...
  group('DDI Singleton Future Basic Tests', () {
    ...
    Future<void> registerSingletonBeans() async {
      ...
      await DDI.instance.singleton(
        () async => A(await DDI.instance.getAsync()),
      );
    }
    ...
    test(
      'Retrieve singleton bean after a second "child" bean is diposed',
      () async {
        await registerSingletonBeans();
    ...
    test(
      'Register a Singleton class with Future PostConstruct mixin',
      () async {
        Future<FuturePostConstruct> localTest() async {
          await Future.delayed(const Duration(milliseconds: 10));
          return FuturePostConstruct();
    ...
    test(
      ...
      () async {
        ...
        final FuturePostConstruct futureInstance = await DDI.instance.get(
          qualifier: 'FuturePostConstruct',
        );
