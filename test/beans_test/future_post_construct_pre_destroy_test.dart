...
void futurePostConstructPreDestroyTest() {
  group('DDI Future PostConstruct and PreDestroy test', () {
    test('Regsiter a Singleton bean with PostConstruct  and PreDestroy', () async {
      await DDI.instance.registerSingleton(clazzRegister: () => Future.delayed(const Duration(milliseconds: 200), L.new));
    ...
    test('Regsiter a Applcation bean with PostConstruct  and PreDestroy', () async {
      DDI.instance.registerApplication(clazzRegister: () => Future.delayed(const Duration(milliseconds: 200), L.new));
    ...
    test('Regsiter a Session bean with PostConstruct  and PreDestroy', () async {
      DDI.instance.registerSession(clazzRegister: () => Future.delayed(const Duration(milliseconds: 200), L.new));
    ...
    test('Regsiter a Dependent bean with PostConstruct  and PreDestroy', () async {
      DDI.instance.registerDependent(clazzRegister: () => Future.delayed(const Duration(milliseconds: 200), L.new));
