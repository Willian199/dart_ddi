...
void futureCircularDetection() {
  group('DDI Future Circular Injection Detection tests', () {
    ...
    test('Inject a Application bean with circular dependency', () {
      ...
      expectLater(() async => DDI.instance.getAsync<Mother>(), throwsA(isA<ConcurrentCreationException>()));
    ...
    test('Inject a Session bean with circular dependency', () {
      DDI.instance.registerSession<Father>(() async => Future.value(Father(mother: await DDI.instance.getAsync<Mother>())));

      DDI.instance.registerSession<Mother>(() async => Future.value(Mother(father: await DDI.instance.getAsync<Father>())));
