...
void main() {
  group('DDI Process Future By Type', () {
    ...
    test(
      'Application Get bean by Type that have registered and dispose',
      () async {
        ...
        expect(
          () => DDI.instance.getAsync(qualifier: keys2[0]),
          throwsA(isA<BeanNotFoundException>()),
        );
        expect(
          () => DDI.instance.getAsync(qualifier: keys2[1]),
          throwsA(isA<BeanNotFoundException>()),
        );
      },
    );
    ...
    test(
      'Dependent Get bean by Type that have registered and dispose',
      () async {
        ...
        expect(
          () => DDI.instance.get(qualifier: keys2[0]),
          throwsA(isA<BeanNotFoundException>()),
        );
        expect(
          () => DDI.instance.get(qualifier: keys2[1]),
          throwsA(isA<BeanNotFoundException>()),
        );
      },
    );
