...
extension P0<BeanT extends Object> on BeanT Function() {
  ...
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(
      this, parameters, returnType, this is Future<Object> Function());
}
...
extension PF0<BeanT extends Object> on Future<BeanT> Function() {
  ...
  CustomFactory<BeanT> get factory =>
      CustomFactory<BeanT>(this, parameters, returnType, true);
}
...
extension P1<BeanT extends Object, A> on BeanT Function(A) {
  ...
  Type get returnType => BeanT;
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(
      this, parameters, returnType, this is Future<Object> Function(A));
}
...
extension P2<BeanT extends Object, A, B> on BeanT Function(A, B) {
  ...
  Type get returnType => BeanT;
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(
      this, parameters, returnType, this is Future<Object> Function(A, B));
}
...
extension P3<BeanT extends Object, A, B, C> on BeanT Function(A, B, C) {
  ...
  Type get returnType => BeanT;
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(
      this, parameters, returnType, this is Future<Object> Function(A, B, C));
}
...
extension P4<BeanT extends Object, A, B, C, D> on BeanT Function(A, B, C, D) {
  ...
  Type get returnType => BeanT;
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(this, parameters,
      returnType, this is Future<Object> Function(A, B, C, D));
}
...
extension P5<BeanT extends Object, A, B, C, D, E> on BeanT Function(
  ...
  Type get returnType => BeanT;
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(this, parameters,
      returnType, this is Future<Object> Function(A, B, C, D, E));
}
...
extension P6<BeanT extends Object, A, B, C, D, E, F> on BeanT Function(
  ...
  Type get returnType => BeanT;
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(this, parameters,
      returnType, this is Future<Object> Function(A, B, C, D, E, F));
}
...
extension P7<BeanT extends Object, A, B, C, D, E, F, G> on BeanT Function(
  ...
  Type get returnType => BeanT;
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(this, parameters,
      returnType, this is Future<Object> Function(A, B, C, D, E, F, G));
}
...
extension P8<BeanT extends Object, A, B, C, D, E, F, G, H> on BeanT Function(
  ...
  Type get returnType => BeanT;
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(this, parameters,
      returnType, this is Future<Object> Function(A, B, C, D, E, F, G, H));
}
...
extension P9<BeanT extends Object, A, B, C, D, E, F, G, H, I> on BeanT Function(
  ...
  Type get returnType => BeanT;
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(this, parameters,
      returnType, this is Future<Object> Function(A, B, C, D, E, F, G, H, I));
}
...
extension P10<BeanT extends Object, A, B, C, D, E, F, G, H, I, J> on BeanT
  ...
  CustomFactory<BeanT> get factory => CustomFactory<BeanT>(
      ...
      parameters,
      returnType,
      this is Future<Object> Function(A, B, C, D, E, F, G, H, I, J));
}
