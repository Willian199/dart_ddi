...
class InstanceFactoryUtil {
  static BeanT create<BeanT extends Object, ParameterT extends Object>({
    ...
    return switch (builder.producer) {
      ...
      final Function f when parameter != null && parameter is List => Function.apply(f, parameter) as BeanT,
      final Function f when parameter != null && parameter is Map => Function.apply(f, null, parameter as Map<Symbol, dynamic>) as BeanT,
      final Function f when parameter != null => Function.apply(f, [parameter]) as BeanT,
      final _ => _autoInject(builder),
    };
  }

  static BeanT _autoInject<BeanT extends Object>(CustomBuilder<FutureOr<BeanT>> builder) {
  ...
  static FutureOr<BeanT> createAsync<BeanT extends Object, ParameterT extends Object>({
    ...
    return switch (builder.producer) {
      ...
      final Function f when parameter != null && parameter is List => Function.apply(f, [...parameter]) as FutureOr<BeanT>,
      final Function f when parameter != null && parameter is Map => Function.apply(f, null, parameter as Map<Symbol, dynamic>) as BeanT,
      final Function f when parameter != null => Function.apply(f, [parameter]) as FutureOr<BeanT>,
      final _ => _autoInjectAsync(builder),
    };
  }

  static FutureOr<BeanT> _autoInjectAsync<BeanT extends Object>(CustomBuilder<FutureOr<BeanT>> builder) async {
