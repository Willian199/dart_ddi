...
//Para tornar possivel criar uma thread
  static Uint8List removeWhiteBackground(Uint8List? bytes) {
    try {
      ...
      final croppedImage = img.copyCrop(image,
          x: 0, y: 0, width: image.width ~/ 1.9, height: image.height);
      final transparentImage =
          _makeColorTransparent(croppedImage, 249, 249, 249);
  ...
  static img.Image? _makeColorTransparent(
      img.Image src, int red, int green, int blue) {
